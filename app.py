...
# API Key de OpenAI desde las variables de entorno
...
def voice():
    ...
    try:
        ...
        response.say("Lo siento, ha ocurrido un error procesando esta llamada. Por favor, intenta más tarde.", voice='Polly.Lupe', language='es-US')
        return Response(str(response), mimetype="text/xml")
